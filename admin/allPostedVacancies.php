...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link btn" href="userPostedVacancies" style="color:#fff; background-color:#3E3EB0;">Posted Job Vacancies</a>
            </li>
          </ul>
        </div>
  ...
  <div class="container" style="margin-top:7%;">
    ...
    <div class="card shadow" style="width: 100%;">
      <div class="card-header"><b>VACANCIES POSTED AS OF <?php echo date('Y-m-d');  ?></b></div>
        ...
        <div class="tableFixHead">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              $query_u = "SELECT * FROM jobs ORDER BY published_date DESC;";
