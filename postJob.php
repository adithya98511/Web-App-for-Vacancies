        ...
        <div class="card-body">
          <form action="postJob.php" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="row">
              <div class="col-md mt-3">
                <div class="mb-3">
                  ...
                  <input class="form-control" id="jobPosition" aria-describedby="jobPosition" type="text" name="jobPosition" placeholder="jobPosition" value="<?php if (isset($jobPosition)) {
                                                                                                                                                                echo $jobPosition;
                                                                                                                                                              } ?>" required>
            ...
            <div class="mb-3">
              ...
              <textarea type="lookingFor" rows="3" name="lookingFor" id="lookingFor" class="form-control" maxlength="200" placeholder="We are looking for ..." value="<?php if (isset($lookingFor)) {
                                                                                                                                                                        echo $lookingFor;
                                                                                                                                                                      } ?>" required></textarea>
            </div>
            ...
            <div class="mb-3">
              ...
              <textarea type="job_profile" rows="5" name="job_profile" id="job_profile" class="form-control" value="<?php if (isset($address)) {
                                                                                                                      echo $address;
                                                                                                                    } ?>" required></textarea>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md mt-3">
                <div class="mb-3">
                  ...
                  <textarea type="address" rows="2" name="address" id="address" class="form-control" value="<?php if (isset($address)) {
                                                                                                              echo $address;
                                                                                                            } ?>" required></textarea>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md mt-3">
                <div class="mb-3">
                  ...
                  <input class="form-control" id="publishedBy" aria-describedby="publishedBy" type="text" name="publishedBy" placeholder="" value="<?php if (isset($u_fname)) {
                                                                                                                                                      echo $u_fname;
                                                                                                                                                    } ?>" required>
                </div>
              </div>
              ...
              <div class="col-md mt-3">
                <div class="mb-3">
                  ...
                  <input type="email" name="email" id="email" class="form-control" placeholder="example@gmail.com" value="<?php if (isset($u_lname)) {
                                                                                                                            echo $u_email;
                                                                                                                          } ?>" required>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 mt-3">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="phone" placeholder="mobile number" aria-describedby="phone" type="tel" placeholder="0713456789" pattern="[0-9]{10}" name="phone" value="<?php if (isset($u_phone)) {
                                                                                                                                                                                                        echo $u_phone;
                                                                                                                                                                                                      } ?>" required>
                </div>
              </div>
